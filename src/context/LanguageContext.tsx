...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'hero.subtitle': 'African Center for Incubation and Innovation (A.F.C.I.I.) bridges research, innovation, and community development.',
  ...
  fr: {
    ...
    'hero.subtitle': 'L\'African Center for Incubation and Innovation (A.F.C.I.I.) fait le pont entre la recherche, l\'innovation et le développement.',
